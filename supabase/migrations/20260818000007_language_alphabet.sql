...
values
  ...
  ('Е','е','ye','ie','like "ye" in yes','como "ie" en siete','ещё','more, still','más, todavía',6),
  ...
  ('Л','л','el','ele','like "l" in lamp','como la "l" de luna','луна','moon','luna',13),
  ...
  ('О','о','o','o','like "o" in more','como la "o" de sol','окно','window','ventana',16),
  ...
  ('С','с','es','ese','like "s" in sun','como la "s" de sol','солнце','sun','sol',19),
  ...
  ('Ъ','ъ','hard sign','signo duro','silent — it separates','muda — separa','объять','to embrace','abrazar',28),
  ('Ы','ы','y','y','a deep "i", further back','una "i" gutural, más atrás','ты','you','tú',29),
